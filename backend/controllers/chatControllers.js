...
const leaveGroup = asyncHandler(async (req, res) => {
    ...
    // Find the chat to check if user is admin
    ...
    if (chat.groupAdmin && chat.groupAdmin.toString() === userId.toString()) {
        return res.status(400).json({ message: "Group admin cannot leave the group" });
    }
...
module.exports = { accessChat, fetchChats, createGroupChat, renameGroup, addToGroup, removeFromGroup, leaveGroup };